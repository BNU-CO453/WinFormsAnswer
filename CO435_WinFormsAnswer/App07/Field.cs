...
namespace CO435_WinFormsAnswer.App07
{
    ...
    public class Field
    {
        ...
        private readonly Random rand = Randomizer.GetRandomGenerator();
        ...
        public Location RandomAdjacentLocation(Location location)
        {
            ...
            int chosen = Randomizer.GetRandomGenerator().Next(adjacent.Count);
            return adjacent[chosen];
        }
        ...
        public Location FreeAdjacentLocation(Location location)
        {
            ...
            if (free.Count > 0)
            {
                int chosen = Randomizer.GetRandomGenerator().Next(free.Count);
                return free[chosen];
            }
            else
            {
